...
public class mapa extends Fragment implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        nGooglemap.setMyLocationEnabled(true);
        nGooglemap.getUiSettings().setMyLocationButtonEnabled(true);

        nGooglemap.addMarker(new MarkerOptions().position(new

                LatLng(20.939287, -89.6169085)).title("Android"));
